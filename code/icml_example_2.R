...
config_path <- paste(code_source_path, 'configs/icml_example2_plot2_config.R', sep = '')
...
# Evaluate
metric_evaluation <- metric_evaluator(X, cluster_data)
graphical_evaluation <- graphical_evaluator_plot2(P, X, cluster_data)
