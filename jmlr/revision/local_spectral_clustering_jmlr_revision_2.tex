...
\begin{itemize}
	...
	\item Although Theroem~\ref{thm:volume_ssd_ub} is stated with respect to the exact PPR vector $p_v$, for a sufficiently small choice of $\varepsilon$, the 
...
\textcolor{red}{(TODO): Either (preferably) replace $C_4$ by a number, or otherwise say that it is a universal constant.}
