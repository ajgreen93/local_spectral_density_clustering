...
\begin{equation*}
\frac{\vol_{n,r}(\wh{C} \vartriangle \mc{C}^{(1)}[X])}{\vol_{n,r}(\mc{C}^{(1)}[X])} \leq 32 C_{1,\delta} \cdot \frac{\rho^2 + \sigma^2}{\sigma r} \cdot \frac{\epsilon}{1 - \epsilon} \cdot \log^2\biggl(\sqrt{C_{2,\delta}} \frac{\rho}{2r}\biggr)
\end{equation*}
...
\begin{itemize}
	...
	\begin{equation*}
	\frac{\epsilon}{1 - \epsilon} \leq \frac{a}{256 C_{1,\delta}} \frac{\sigma^2}{(\rho^2 + \sigma^2) \log^2(\rho/\sigma \sqrt{C_{2,\delta}})},
	\end{equation*}
