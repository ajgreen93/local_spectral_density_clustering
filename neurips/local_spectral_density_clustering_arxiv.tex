...
and edges correspond to proximities between samples. It then estimates a feature
...
\paragraph{Summary of results.} A summary of our results (and an outline for this
paper) is as follows.
...
Our goal is not to improve on these
